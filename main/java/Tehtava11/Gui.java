...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        ListView<StateMetadata> listView = new ListView<StateMetadata>();
        ...
        Label label1 = new Label( "Press Ctrl-Y to undo the last change.");
        label1.setPadding(insets);
        Label label2 = new Label( "Press Ctrl-H open history");
    ...
    public void showHistoryWindow(Controller controller) {
        Stage stage = new Stage();
        ListView<StateMetadata> listView = new ListView<>();
        listView.getItems().addAll(controller.getFullHistory());

        listView.setOnMouseClicked(event -> {
            StateMetadata selected = listView.getSelectionModel().getSelectedItem();
            if (selected != null) {
                controller.restoreFromMetadata(selected);
            }
        });
